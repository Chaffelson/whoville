...
class GeneralSettings(object):
    ...
    def __init__(self, name=None, credential_name=None):
        """
    ...
    def name(self):
        """
        Gets the name of this GeneralSettings.
        name of the stack

        :return: The name of this GeneralSettings.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this GeneralSettings.
        name of the stack

        :param name: The name of this GeneralSettings.
        :type: str
        """
        if name is None:
    ...
    def credential_name(self):
        """
        Gets the credential_name of this GeneralSettings.
        credential resource name for the stack

        :return: The credential_name of this GeneralSettings.
        :rtype: str
        """
    ...
    def credential_name(self, credential_name):
        """
        Sets the credential_name of this GeneralSettings.
        credential resource name for the stack

        :param credential_name: The credential_name of this GeneralSettings.
        :type: str
        """
        if credential_name is None:
            raise ValueError("Invalid value for `credential_name`, must not be `None`")
