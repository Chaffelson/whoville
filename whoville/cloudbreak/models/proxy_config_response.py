...
class ProxyConfigResponse(object):
    """
    ...
    def __init__(self, name=None, description=None, server_host=None, server_port=None, protocol=None, user_name=None, id=None, workspace=None):
        """
        ProxyConfigResponse - a model defined in Swagger
        """
    ...
    def name(self):
        """
        Gets the name of this ProxyConfigResponse.
        Name of the proxy configuration resource

        :return: The name of this ProxyConfigResponse.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this ProxyConfigResponse.
        Name of the proxy configuration resource

        :param name: The name of this ProxyConfigResponse.
        :type: str
        """
        if name is None:
    ...
    def description(self):
        """
        Gets the description of this ProxyConfigResponse.
        description of the resource

        :return: The description of this ProxyConfigResponse.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this ProxyConfigResponse.
        description of the resource

        :param description: The description of this ProxyConfigResponse.
        :type: str
        """
    ...
    def server_host(self):
        """
        Gets the server_host of this ProxyConfigResponse.
        host or IP address of proxy server

        :return: The server_host of this ProxyConfigResponse.
        :rtype: str
        """
    ...
    def server_host(self, server_host):
        """
        Sets the server_host of this ProxyConfigResponse.
        host or IP address of proxy server

        :param server_host: The server_host of this ProxyConfigResponse.
        :type: str
        """
    ...
    def server_port(self):
        """
        Gets the server_port of this ProxyConfigResponse.
        port of proxy server (typically: 3128 or 8080)

        :return: The server_port of this ProxyConfigResponse.
        :rtype: int
        """
    ...
    def server_port(self, server_port):
        """
        Sets the server_port of this ProxyConfigResponse.
        port of proxy server (typically: 3128 or 8080)

        :param server_port: The server_port of this ProxyConfigResponse.
        :type: int
        """
    ...
    def protocol(self):
        """
        Gets the protocol of this ProxyConfigResponse.
        determines the protocol (http or https)

        :return: The protocol of this ProxyConfigResponse.
        :rtype: str
        """
    ...
    def protocol(self, protocol):
        """
        Sets the protocol of this ProxyConfigResponse.
        determines the protocol (http or https)

        :param protocol: The protocol of this ProxyConfigResponse.
        :type: str
        """
        if protocol is None:
    ...
    def user_name(self):
        """
        Gets the user_name of this ProxyConfigResponse.
        Username to use for basic authentication

        :return: The user_name of this ProxyConfigResponse.
        :rtype: str
        """
    ...
    def user_name(self, user_name):
        """
        Sets the user_name of this ProxyConfigResponse.
        Username to use for basic authentication

        :param user_name: The user_name of this ProxyConfigResponse.
        :type: str
        """
    ...
    def id(self):
        """
        Gets the id of this ProxyConfigResponse.
        proxy configuration id for the cluster

        :return: The id of this ProxyConfigResponse.
        :rtype: int
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this ProxyConfigResponse.
        proxy configuration id for the cluster

        :param id: The id of this ProxyConfigResponse.
        :type: int
        """
    ...
    def workspace(self):
        """
        Gets the workspace of this ProxyConfigResponse.
        workspace of the resource

        :return: The workspace of this ProxyConfigResponse.
    ...
    def workspace(self, workspace):
        """
        Sets the workspace of this ProxyConfigResponse.
        workspace of the resource

        :param workspace: The workspace of this ProxyConfigResponse.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ProxyConfigResponse):
            return False
