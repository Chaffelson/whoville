...
class ClusterRequest(object):
    ...
    attribute_map = {
        ...
        'validate_repositories': 'validateRepositories',
        'ambari_stack_details': 'ambariStackDetails',
    ...
    def __init__(self, name=None, blueprint_id=None, blueprint_name=None, blueprint=None, description=None, host_groups=None, gateway=None, enable_security=False, user_name=None, password=None, kerberos=None, ldap_config_id=None, ldap_config_name=None, ldap_config=None, validate_blueprint=False, validate_repositories=False, ambari_stack_details=None, ambari_repo_details_json=None, rds_config_ids=None, rds_config_names=None, ambari_database_details=None, rds_config_jsons=None, file_system=None, config_strategy=None, blueprint_inputs=None, blueprint_custom_properties=None, custom_container=None, custom_queue=None, executor_type=None, connected_cluster=None, ambari_security_master_key=None, proxy_name=None):
        """
        ...
        self._validate_repositories = None
        ...
        if validate_repositories is not None:
          self.validate_repositories = validate_repositories
    ...
    def validate_repositories(self):
        """
        Gets the validate_repositories of this ClusterRequest.
        ambari and stack repository validation

        :return: The validate_repositories of this ClusterRequest.
        :rtype: bool
        """
        return self._validate_repositories

    @validate_repositories.setter
    def validate_repositories(self, validate_repositories):
        """
        Sets the validate_repositories of this ClusterRequest.
        ambari and stack repository validation

        :param validate_repositories: The validate_repositories of this ClusterRequest.
        :type: bool
        """

        self._validate_repositories = validate_repositories
