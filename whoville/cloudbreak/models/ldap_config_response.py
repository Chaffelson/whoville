...
class LdapConfigResponse(object):
    """
    ...
    def description(self):
        """
        Gets the description of this LdapConfigResponse.
        description of the resource

        :return: The description of this LdapConfigResponse.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this LdapConfigResponse.
        description of the resource

        :param description: The description of this LdapConfigResponse.
        :type: str
        """
    ...
    def server_host(self):
        """
        Gets the server_host of this LdapConfigResponse.
        public host or IP address of LDAP server

        :return: The server_host of this LdapConfigResponse.
        :rtype: str
        """
    ...
    def server_host(self, server_host):
        """
        Sets the server_host of this LdapConfigResponse.
        public host or IP address of LDAP server

        :param server_host: The server_host of this LdapConfigResponse.
        :type: str
        """
    ...
    def server_port(self):
        """
        Gets the server_port of this LdapConfigResponse.
        port of LDAP server (typically: 389 or 636 for LDAPS)

        :return: The server_port of this LdapConfigResponse.
        :rtype: int
        """
    ...
    def server_port(self, server_port):
        """
        Sets the server_port of this LdapConfigResponse.
        port of LDAP server (typically: 389 or 636 for LDAPS)

        :param server_port: The server_port of this LdapConfigResponse.
        :type: int
        """
    ...
    def protocol(self):
        """
        Gets the protocol of this LdapConfigResponse.
        determines the protocol (LDAP or LDAP over SSL)

        :return: The protocol of this LdapConfigResponse.
        :rtype: str
        """
    ...
    def protocol(self, protocol):
        """
        Sets the protocol of this LdapConfigResponse.
        determines the protocol (LDAP or LDAP over SSL)

        :param protocol: The protocol of this LdapConfigResponse.
        :type: str
        """
    ...
    def bind_dn(self, bind_dn):
        """
        Sets the bind_dn of this LdapConfigResponse.
        bind distinguished name for connection test and group search (e.g. cn=admin,dc=example,dc=org)

        :param bind_dn: The bind_dn of this LdapConfigResponse.
        :type: str
        """
        if bind_dn is None:
    ...
    def user_search_base(self):
        """
        Gets the user_search_base of this LdapConfigResponse.
        template for user search for authentication (e.g. dc=hadoop,dc=apache,dc=org)

        :return: The user_search_base of this LdapConfigResponse.
        :rtype: str
        """
    ...
    def user_search_base(self, user_search_base):
        """
        Sets the user_search_base of this LdapConfigResponse.
        template for user search for authentication (e.g. dc=hadoop,dc=apache,dc=org)

        :param user_search_base: The user_search_base of this LdapConfigResponse.
        :type: str
        """
    ...
    def user_dn_pattern(self):
        """
        Gets the user_dn_pattern of this LdapConfigResponse.
        template for pattern based user search for authentication (e.g. cn={0},dc=hadoop,dc=apache,dc=org)

        :return: The user_dn_pattern of this LdapConfigResponse.
        :rtype: str
        """
    ...
    def user_dn_pattern(self, user_dn_pattern):
        """
        Sets the user_dn_pattern of this LdapConfigResponse.
        template for pattern based user search for authentication (e.g. cn={0},dc=hadoop,dc=apache,dc=org)

        :param user_dn_pattern: The user_dn_pattern of this LdapConfigResponse.
        :type: str
        """
    ...
    def group_search_base(self):
        """
        Gets the group_search_base of this LdapConfigResponse.
        template for group search for authorization (e.g. dc=hadoop,dc=apache,dc=org)

        :return: The group_search_base of this LdapConfigResponse.
        :rtype: str
        """
    ...
    def group_search_base(self, group_search_base):
        """
        Sets the group_search_base of this LdapConfigResponse.
        template for group search for authorization (e.g. dc=hadoop,dc=apache,dc=org)

        :param group_search_base: The group_search_base of this LdapConfigResponse.
        :type: str
        """
    ...
    def user_name_attribute(self):
        """
        Gets the user_name_attribute of this LdapConfigResponse.
        attribute name for simplified search filter (e.g. sAMAccountName in case of AD, UID or cn for LDAP).

        :return: The user_name_attribute of this LdapConfigResponse.
        :rtype: str
        """
    ...
    def user_name_attribute(self, user_name_attribute):
        """
        Sets the user_name_attribute of this LdapConfigResponse.
        attribute name for simplified search filter (e.g. sAMAccountName in case of AD, UID or cn for LDAP).

        :param user_name_attribute: The user_name_attribute of this LdapConfigResponse.
        :type: str
        """
    ...
    def domain(self):
        """
        Gets the domain of this LdapConfigResponse.
        domain in LDAP server (e.g. ad.seq.com).

        :return: The domain of this LdapConfigResponse.
        :rtype: str
        """
        return self._domain
    ...
    def domain(self, domain):
        """
        Sets the domain of this LdapConfigResponse.
        domain in LDAP server (e.g. ad.seq.com).

        :param domain: The domain of this LdapConfigResponse.
        :type: str
        """
    ...
    def directory_type(self):
        """
        Gets the directory_type of this LdapConfigResponse.
        directory type of server LDAP or AD

        :return: The directory_type of this LdapConfigResponse.
        :rtype: str
        """
    ...
    def directory_type(self, directory_type):
        """
        Sets the directory_type of this LdapConfigResponse.
        directory type of server LDAP or AD

        :param directory_type: The directory_type of this LdapConfigResponse.
        :type: str
        """
    ...
    def user_object_class(self):
        """
        Gets the user_object_class of this LdapConfigResponse.
        User Object Class (defaults to person)

        :return: The user_object_class of this LdapConfigResponse.
        :rtype: str
        """
    ...
    def user_object_class(self, user_object_class):
        """
        Sets the user_object_class of this LdapConfigResponse.
        User Object Class (defaults to person)

        :param user_object_class: The user_object_class of this LdapConfigResponse.
        :type: str
        """
    ...
    def group_object_class(self):
        """
        Gets the group_object_class of this LdapConfigResponse.
        Group Object Class (defaults to groupOfNames)

        :return: The group_object_class of this LdapConfigResponse.
        :rtype: str
        """
    ...
    def group_object_class(self, group_object_class):
        """
        Sets the group_object_class of this LdapConfigResponse.
        Group Object Class (defaults to groupOfNames)

        :param group_object_class: The group_object_class of this LdapConfigResponse.
        :type: str
        """
    ...
    def group_name_attribute(self):
        """
        Gets the group_name_attribute of this LdapConfigResponse.
        Group Id Attribute (defaults to cn)

        :return: The group_name_attribute of this LdapConfigResponse.
        :rtype: str
        """
    ...
    def group_name_attribute(self, group_name_attribute):
        """
        Sets the group_name_attribute of this LdapConfigResponse.
        Group Id Attribute (defaults to cn)

        :param group_name_attribute: The group_name_attribute of this LdapConfigResponse.
        :type: str
        """
    ...
    def group_member_attribute(self):
        """
        Gets the group_member_attribute of this LdapConfigResponse.
        Group Member Attribute (defaults to member)

        :return: The group_member_attribute of this LdapConfigResponse.
        :rtype: str
        """
    ...
    def group_member_attribute(self, group_member_attribute):
        """
        Sets the group_member_attribute of this LdapConfigResponse.
        Group Member Attribute (defaults to member)

        :param group_member_attribute: The group_member_attribute of this LdapConfigResponse.
        :type: str
        """
    ...
    def admin_group(self):
        """
        Gets the admin_group of this LdapConfigResponse.
        LDAP group for administrators

        :return: The admin_group of this LdapConfigResponse.
        :rtype: str
        """
    ...
    def admin_group(self, admin_group):
        """
        Sets the admin_group of this LdapConfigResponse.
        LDAP group for administrators

        :param admin_group: The admin_group of this LdapConfigResponse.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this LdapConfigResponse.
        name of the resource

        :return: The name of this LdapConfigResponse.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this LdapConfigResponse.
        name of the resource

        :param name: The name of this LdapConfigResponse.
        :type: str
        """
        if name is None:
    ...
    def id(self):
        """
        Gets the id of this LdapConfigResponse.
        id of the resource

        :return: The id of this LdapConfigResponse.
        :rtype: int
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this LdapConfigResponse.
        id of the resource

        :param id: The id of this LdapConfigResponse.
        :type: int
        """
    ...
    def public(self):
        """
        Gets the public of this LdapConfigResponse.
        resource is visible in account

        :return: The public of this LdapConfigResponse.
        :rtype: bool
        """
        return self._public
    ...
    def public(self, public):
        """
        Sets the public of this LdapConfigResponse.
        resource is visible in account

        :param public: The public of this LdapConfigResponse.
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, LdapConfigResponse):
            return False
