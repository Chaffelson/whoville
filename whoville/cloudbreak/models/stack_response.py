...
class StackResponse(object):
    ...
    swagger_types = {
        ...
        'node_count': 'int',
        'hardware_info_groups': 'list[HardwareInfoGroupResponse]',
    ...
    attribute_map = {
        ...
        'hardware_info_groups': 'hardwareInfoGroups',
    ...
    def __init__(self, name=None, availability_zone=None, region=None, platform_variant=None, credential_id=None, on_failure_action=None, network_id=None, ambari_version=None, hdp_version=None, parameters=None, custom_domain=None, custom_hostname=None, cluster_name_as_subdomain=False, hostgroup_name_as_hostname=False, application_tags=None, user_defined_tags=None, default_tags=None, custom_inputs=None, id=None, owner=None, account=None, status=None, cluster=None, status_reason=None, credential=None, network=None, instance_groups=None, failure_policy=None, orchestrator=None, created=None, terminated=None, gateway_port=None, image=None, cloudbreak_details=None, flex_subscription=None, stack_authentication=None, node_count=None, hardware_info_groups=None, cloudbreak_events=None, workspace=None, cloud_platform=None, public=False):
        ...
        self._hardware_info_groups = None
        ...
        if hardware_info_groups is not None:
          self.hardware_info_groups = hardware_info_groups
    ...
    def terminated(self):
        """
        Gets the terminated of this StackResponse.
        termination completion time of stack in long

        :return: The terminated of this StackResponse.
        :rtype: int
        """
    ...
    def terminated(self, terminated):
        """
        Sets the terminated of this StackResponse.
        termination completion time of stack in long

        :param terminated: The terminated of this StackResponse.
        :type: int
        """
    ...
    @property
    def hardware_info_groups(self):
        """
        Gets the hardware_info_groups of this StackResponse.
        hardware information where pairing hostmetadata with instancemetadata

        :return: The hardware_info_groups of this StackResponse.
        :rtype: list[HardwareInfoGroupResponse]
        """
        return self._hardware_info_groups

    @hardware_info_groups.setter
    def hardware_info_groups(self, hardware_info_groups):
        """
        Sets the hardware_info_groups of this StackResponse.
        hardware information where pairing hostmetadata with instancemetadata

        :param hardware_info_groups: The hardware_info_groups of this StackResponse.
        :type: list[HardwareInfoGroupResponse]
        """

        self._hardware_info_groups = hardware_info_groups
    ...
    def workspace(self):
        """
        Gets the workspace of this StackResponse.
        workspace of the resource

        :return: The workspace of this StackResponse.
    ...
    def workspace(self, workspace):
        """
        Sets the workspace of this StackResponse.
        workspace of the resource

        :param workspace: The workspace of this StackResponse.
