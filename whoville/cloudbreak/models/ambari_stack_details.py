...
class AmbariStackDetails(object):
    ...
    def __init__(self, stack=None, version=None, os=None, os_type=None, stack_repo_id=None, stack_base_url=None, utils_repo_id=None, utils_base_url=None, enable_gpl_repo=False, verify=False, repository_version=None, version_definition_file_url=None, mpack_url=None, mpacks=None, gpg_key_url=None):
        """
    ...
    def version(self, version):
        ...
        :type: str
        """
        if version is not None and not re.search('(^[0-9]+\\.[0-9]+$)', version):
            raise ValueError("Invalid value for `version`, must be a follow pattern or equal to `/(^[0-9]+\\.[0-9]+$)/`")
    ...
    def os_type(self):
        """
        Gets the os_type of this AmbariStackDetails.
        operating system type for the stack, like centos6

        :return: The os_type of this AmbariStackDetails.
        :rtype: str
        """
    ...
    def os_type(self, os_type):
        """
        Sets the os_type of this AmbariStackDetails.
        operating system type for the stack, like centos6

        :param os_type: The os_type of this AmbariStackDetails.
        :type: str
        """
    ...
    def gpg_key_url(self):
        """
        Gets the gpg_key_url of this AmbariStackDetails.
        gpg key of the Ambari repository

        :return: The gpg_key_url of this AmbariStackDetails.
        :rtype: str
        """
    ...
    def gpg_key_url(self, gpg_key_url):
        """
        Sets the gpg_key_url of this AmbariStackDetails.
        gpg key of the Ambari repository

        :param gpg_key_url: The gpg_key_url of this AmbariStackDetails.
        :type: str
        """
